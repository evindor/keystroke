...
- **Frecency.** Selections of apps and Omarchy commands earn a bounded bonus (14-day half-life). State lives in `~/.local/state/keystroke/usage.json` as hashed ids only.
