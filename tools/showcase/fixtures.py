...
'files':dict(scope='files',title='Files',query='readme',provider='files',rows=[row('README.md','~/Projects/keystroke/README.md','󰈙','Files',altVerb='Open terminal'),row('README.md','~/Projects/weekend-app/README.md','󰈙','Files',altVerb='Open terminal'),row('README.md','~/Documents/notes/README.md','󰈙','Files',altVerb='Open terminal'),row('README.md','~/Projects/dotfiles/README.md','󰈙','Files',altVerb='Open terminal')]),
